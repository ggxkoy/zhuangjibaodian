...
const { PARSE_SYSTEM, personaFor, reviewSystem, buildContext } = require('./boss-prompts');
...
module.exports = { configured, parseRequirement, reviewBuild, bossChat, digestReviews };
